...
NEURO_SALER = {
    "EXTRACTORS": {
        ...
        "remove_greeting": {
            ...
            "examples": [
                {
                    "input": "Добрый день, Кира, я готов рассказать Вам о курсе подробнее. Начнем с тарифов?",
                    "output": "Кира, я готов рассказать Вам о курсе подробнее. Начнем с тарифов?"
                },
                {
                    "input": "Привет, Сергей! Сегодня у нас отличная погода.",
                    "output": "Сергей! Сегодня у нас отличная погода."
                },
                {
                    "input": "Здравствуйте, коллеги. Начнем собрание.",
                    "output": "Коллеги. Начнем собрание."
                }
            ],
            "instructions": "Удали приветствие в тексте."
        },
