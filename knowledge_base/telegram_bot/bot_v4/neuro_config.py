EXTRACTOR_ROLES = {
    ...
    "resolved_objection_detector": {
        ...
        "system_prompt": '''
            ...
            У тебя для анализа есть Вопрос Клиента и Ответ Менеджера отдела продаж.
            Твоя задача - тщательно выявлять отработал ли Менеджера отдела продаж возражения в своем ответе клиенту.
            Ты всегда очень строго следуешь порядку отчета.
        ''',
        "instructions": '''
            Давай действовать последовательно:
            Проанализируй ответ Менеджера отдела продаж и найди в нем отработки возражений в вопросе Клиента (если они есть) 
            и напиши их.
